...
const cartSiedBar = document.querySelector(".cart-sidebar")
...
cart.addEventListener("click", function () {
    cartSiedBar.syle.transform = "translate(0%)"
...
closeCart.addEventListener("click"), function() {
    cartSiedBar.style.transform = "translate(100%)"
    const bodyOverlay = ducument.querySelector(".overlay")
    ducument.querySelector(".body").removeChild(bodyoverlay)
}
...
class UI {
    displayPrroducts(products) {
        let result = "";
        products.forEach(product => {
            const productDiv = document.createElement("div");
            productDiv.innerHTML = <div class="product-card"></div>
                ,
                ...
                ,
                <div class="product-name">${product.titlr}</div>
                ,
                <div class="product-pricing">${product.price} </div>

            const p = ducument.querySelector("product")
            p.append(productDiv)
        });
    }
    ...
    setCartValues(cart) {
        ...
        cartItems(cartItems){
            ...
            cartItemUi.innerHTML = <div class="cart product">
                ...
                <div class="cart-product-content"></div>
                <div class="cart-product-name"><h3>${cartItem.titile}</h3></div>
